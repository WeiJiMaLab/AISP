...
switch type
    case 'bayes'
        ...
        save(sprintf('pars/parsBayes_%d_%d.mat',iSubj,iRep),'pars','likelihood')
    case 'freq'
        ...
        save(sprintf('pars/parsFreq_%d_%d.mat',iSubj,iRep),'pars','likelihood')
    case 'freq2'
        [pars,likelihood] = bads(fun_handle,[2,1,0,-1,-1,-1,-2,0,0.01],[-5,-5,-5,-5,-5,-5,-10,-2,eps],[5,5,5,5,5,5,10,5,0.75],[-3,-3,-3,-3,-3,-3,-4,-2,0.01],[5,4,3,3,3,2,10,5,0.1]);
        save(sprintf('pars/parsFreq2_%d_%d.mat',iSubj,iRep),'pars','likelihood')
    case 'freq3'
        [pars,likelihood] = bads(fun_handle,[2,1,0,-1,-1,-1,-2,0,0.01],[-5,-5,-5,-5,-5,-5,-10,-2,eps],[5,5,5,5,5,5,10,5,0.75],[-3,-3,-3,-3,-3,-3,-4,-2,0.01],[5,4,3,3,3,2,10,5,0.1]);
        save(sprintf('pars/parsFreq3_%d_%d.mat',iSubj,iRep),'pars','likelihood')
end