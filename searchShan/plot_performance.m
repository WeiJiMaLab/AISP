...
for i_sigma = sigmas_test
    ...
    response_samp = sample_simulate(data, [i_sigma, beta, lambda, 10]);
    response_cssamp = cssample_simulate(data, [i_sigma, beta, lambda, 10]);
    performances(k, :) = [ ...
